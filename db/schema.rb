...
ActiveRecord::Schema.define(version: 20180129163735) do
  ...
  add_index "facebook_slides", ["facebook_post_id", "url"], name: "index_facebook_slides_on_facebook_post_id_and_url", unique: true, using: :btree
